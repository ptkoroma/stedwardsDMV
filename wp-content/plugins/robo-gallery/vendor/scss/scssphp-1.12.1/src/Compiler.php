...
class Compiler
{
    ...
    /**
     * @var \ScssPhpRBE\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \ScssPhpRBE\ScssPhp\Parser
     */
     ...
     *
     * @return \ScssPhpRBE\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \ScssPhpRBE\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \ScssPhpRBE\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \ScssPhpRBE\ScssPhp\Formatter\OutputBlock
     */
     ...
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \ScssPhpRBE\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $scope
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \ScssPhpRBE\ScssPhp\Block|\ScssPhpRBE\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \ScssPhpRBE\ScssPhp\Formatter\OutputBlock $out
     * @param \ScssPhpRBE\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \ScssPhpRBE\ScssPhp\Compiler\Environment $env
     * @param \ScssPhpRBE\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @return array
     */
    protected function multiplyMedia( $env = null, $childQueries = null)
    {
        if (
            ! isset($env) ||
     ...
     * @param \ScssPhpRBE\ScssPhp\Block $block
     *
     * @return \ScssPhpRBE\ScssPhp\Compiler\Environment
     */
     ...
     * @return void
     */
    protected function set($name, $value, $shadow = false,  $env = null, $valueUnreduced = null)
    {
     ...
     * @return mixed|null
     */
    public function get($name, $shouldThrow = true,  $env = null, $unreduced = false)
    {
        $normalizedName = $this->normalizeName($name);
        $specialContentKey = static::$namespaces['special'] . 'content';
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\ScssPhpRBE\ScssPhp\ValueConverter::parseValue" or "\ScssPhpRBE\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \ScssPhpRBE\ScssPhp\Compiler
     *
